...
export const toolContent: Record<string, ToolContent> = {
  ...
  "/tools/employment-damages-estimator": {
    howItWorks: [
      ...
      `Front pay is forward-looking: months of front pay multiplied by the difference between the old compensation plus benefits and the current job's pay (if the plaintiff is working — check the “currently employed” box on that job and the offset applies automatically).`,
      `Additional damages cover the categories that vary by statute and case: compensatory damages for emotional distress, liquidated damages (2× net back-pay compensation under FLSA/ADEA/EPA-type statutes, 2× net compensation plus benefits under FMLA, or 3× under some state statutes), punitive damages, and anything else. The breakdown shows every component so the total is easy to defend — or attack.`,
    ],
    example: [
      `A plaintiff earning $7,000 a month plus $1,500 in benefits, terminated 12 months ago, has gross back pay of $102,000. She worked 6 of those months at $5,000 a month — $30,000 of mitigation — leaving net back pay of $72,000. Six months of front pay at $3,500 a month ($8,500 comp plus benefits, offset by the $5,000 current job) adds $21,000. Add $50,000 of emotional distress and the estimate is $143,000 before any liquidated or punitive component.`,
    ],
    whenToUse: [
