...
export const metadata: Metadata = {
  ...
  description: "Calculate simple interest on any amount over any time period at any rate.",
};
  ...
  return (
    <>
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-brand-primary">Simple Interest Calculator</h1>
        <p className="mt-2 text-brand-muted">Calculate simple interest on any amount over any time period at any rate.</p>
      </div>
