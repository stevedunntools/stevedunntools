...
export const metadata: Metadata = {
  ...
  description: "Calculate potential employment damages including lost wages, benefits, and emotional distress.",
};
  ...
  return (
    <>
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-brand-primary">Employment Damages Estimator</h1>
        <p className="mt-2 text-brand-muted">Calculate potential employment damages including lost wages, benefits, and emotional distress.</p>
      </div>
